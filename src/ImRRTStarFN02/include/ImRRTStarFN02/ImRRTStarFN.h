...
#include "ImRRTStarFN02/collision_detector.h"
...
private:
    ...
    double current_cost{-1}; // current path cost
    costmap_2d::Costmap2D* costmap_{nullptr};
    std::vector<Node> nodes_; // nodes array
    std::vector<int> nodes_fn_; // fixNode index array
    int fixNode_;
