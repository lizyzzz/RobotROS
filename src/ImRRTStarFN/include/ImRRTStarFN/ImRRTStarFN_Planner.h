...
class ImRRTStarFN_planner : public nav_core::BaseGlobalPlanner {
public:
    ImRRTStarFN_planner();
    ImRRTStarFN_planner(std::string name, costmap_2d::Costmap2DROS* costmap_ros);
    ImRRTStarFN_planner(std::string name, costmap_2d::Costmap2D* costmap, std::string global_frame);
    ~ImRRTStarFN_planner();
